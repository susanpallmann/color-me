...
window.onload = function() {
  ...
  $(".draggable").on("mousedown touchstart", function(e) {
    ...
    if (e.type === "touchstart") {
        ...
        var prevX = e.originalEvent.changedTouches[0].pageX;
        var prevY = e.originalEvent.changedTouches[0].pageY;
    } else {
    ...
    $(this).parent().on("mousemove touchmove", function(e) {
        ...
        if (e.type === "touchmove") {
            var x = $(target).offset().left + (e.originalEvent.changedTouches[0].pageX - prevX);
            var y = $(target).offset().top + (e.originalEvent.changedTouches[0].pageY - prevY);
        } else {
