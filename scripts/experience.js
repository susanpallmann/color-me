...
function loadPerspective(perspID) {
    firebase.database().ref('perspectives/' + perspID).once('value').then(function(snapshot) {
        ...
        compSat = compColor[1];
        compLgh = compColor[2];
        $("div.stage:nth-child(odd)").css("background-image", "radial-gradient(at bottom right, hsl(" + hue + ", " + sat + "%, " + lgh + "%), hsl(" + compHue + ", " + compSat + "%, " + compLgh + "%))");
        $("div.stage:nth-child(even)").css("background-image", "radial-gradient(at top right, hsl(" + hue + ", " + sat + "%, " + lgh + "%), hsl(" + compHue + ", " + compSat + "%, " + compLgh + "%))");
